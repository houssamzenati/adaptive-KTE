...
name_folder_list_adaptive_null = ['results/' + 'adaptive_sigmoidal' + '/']
...
plot_power_scenarios_adaptive_alternative(
    ...
    ns_list=ns_list,
    methods=['VS-DR-KTE', 'CADR', 'Hadad'],
    name_folder='results/adaptive_sigmoidal/',
    split_suffix='_alternating.csv',
    alpha=0.05,
    save_path='plots/scenarios_II_III_IV_adaptive_sigmoidal_power.png'
)

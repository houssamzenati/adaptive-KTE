...
plt.tight_layout()
plt.savefig(
    f"plots/REVIEWED_null_dr_adaptive_cosine_{case}_errorbar.png", bbox_inches="tight"
)
plt.show()
...
# b_list = ["II", "III", "IV"]
# method_list = ["Projected-DR-KTE", "CADR", "Hadad"]
...
# methods_false_null = ["Projected-DR-KTE", "CADR", "Hadad"]
# case_list_false_null = [1]

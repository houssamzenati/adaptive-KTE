...
def collect_epsilon_greedy_from_X(
    ...
    split="alternating", one_indexed=True, sample_replace = False,
):
    """
        ...
        for method in method_list:
            for ns in tqdm(ns_list):
                ...
                for n in range(num_experiments):
                    ...
                    X, T, Y, w, Pi_0_on_0, Pi_1_on_1, idx0, idx1, P_all = collect_epsilon_greedy_from_X(
                        X_all,
...
plt.tight_layout()
plt.savefig(f"plots/REVIEWED_null_dr_adaptive_IHDP{case}_errorbar.png", bbox_inches='tight')
plt.show()

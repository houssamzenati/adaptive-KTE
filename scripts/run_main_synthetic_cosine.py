...
def main():
    ...
    output_dir = "results/main_cosine_synthetic"
    ...
    plot_calibration(
        ...
        calibration_sizes,
        "PADR-KTE",
        "figures/REVIEWED_null_dr_adaptive_cosine_1_errorbar.png",
        "Cosine synthetic",
    )
    plot_power(
        output_dir,
        power_sizes,
        ["PADR-KTE", "CADR", "AW-AIPW"],
        "figures/scenarios_II_III_IV_adaptive_cosine_power.png",
        "Cosine synthetic",
    )

    summary = save_rejection_table(
        output_dir,
        ["I", "II", "III", "IV"],
        sorted(set(calibration_sizes + power_sizes)),
        ["PADR-KTE", "CADR", "AW-AIPW"],
        "results/main_cosine_synthetic/rejection_summary.csv",
    )
    save_latex_table(
        summary[summary["sample_size"].isin(power_sizes)],
        row_key="method",
        column_key="scenario",
        value_key="rejection_rate",
        save_path="results/main_cosine_synthetic/rejection_summary.tex",
